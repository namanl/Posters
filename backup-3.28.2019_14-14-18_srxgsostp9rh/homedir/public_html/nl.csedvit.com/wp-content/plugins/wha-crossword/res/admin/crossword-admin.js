jQuery(document).ready(function ($) {
    ...
    jQuery(document).on('click', 'body .wha-crossword-row-admin .wha-add-crossword-item', function (event) {
        ...
        var data = '<div class="wha-crossword-item">' +
            ...
            '<div class="wha-crossword-inner"><label>Clue</label><input type="text"  name="wha-crossword-clue[]" value="" required size="25" /></div>' +
            '<div class="wha-crossword-inner"><label>Word</label><input type="text"  name="wha-crossword-word[]" value="" size="25" required /></div>' +
            '</div>' +
