if (document.getElementById("wha-crossword")) {
    ...
    var crossword_ansver = crossword_vars.whacw_ansver;
    ...
    var correct_ansver = optional_crossword_vars.whacw_correct_ansver;
    ...
    function Play() {
        ...
        jQuery('.wha-square.wha-letter.wha-first').each(function (index, value) {
            ...
            jQuery(this).append("<div class='wha-counter'>" + r.replace(' , ', ',') + "</div>");
        });
                ...
                for (var v = 0; v < arr_el.length; v++) {
                    ...
                    if (useGlobalOptions == 'yes') {
                        if (flag_empty != 'empty' && flag_correct == true) {
                            if (dir == 0 && crossword_ansver == 'yes') {  /* added check if crossword_ansver value 'yes' */
                                for (var z = df; z < arr_char.length + df; z++) {
                                    jQuery('.wha-square.wha-letter[data-x="' + z + '"][data-y="' + y + '"] ').addClass('wha-correct');
                                }
                            }
                            else {
                                for (var z = df; z < arr_char.length + df; z++) {
                                    jQuery('.wha-square.wha-letter[data-y="' + z + '"][data-x="' + x + '"] ').addClass('wha-correct');
                                }
                            }
                        }
                        ...
                        if (flag_empty != 'empty' && flag_correct == false) {
                            if (dir == 0 && crossword_ansver_incorect == 'yes') { /* added check if crossword_ansver_incorect value 'yes' */
                                for (var z = df; z < arr_char.length + df; z++) {
                        ...
                        if (flag_empty != 'empty' && flag_correct == true) {
                            if (dir == 0 && correct_ansver == 'yes') {  /* added check if crossword_ansver value 'yes' */
                                for (var z = df; z < arr_char.length + df; z++) {
                                    jQuery('.wha-square.wha-letter[data-x="' + z + '"][data-y="' + y + '"] ').addClass('wha-correct');
                                }
                            }
        ...
        jQuery('.wha-char').on('keydown',function(e) {
            ...
            if (e.which == 46 || e.which == 8) {
                ...
                // Move Y
                    ...
                    if (jQuery(window).width() > 769) {
                        jQuery(this).parent('div.wha-letter').parent('div.row').next('div.row').find('[data-x="'+x+'"]').find('input').focus();
                    }
                }
            }
            // Left arrow
            ...
            if (e.which == 40) {
                datay++;
                jQuery(this).parent().parent().next().find('[data-y = "' + datay + '"]').find('input').focus();
            }
        });
                    ...
                    for(var k=0; k<div_ch.length; k++) {
                        ...
                        if(div_ch[k].nodeName == "INPUT"){
                            ...
                            div_ch[k].addEventListener('input', function(e){
                                ...
                                // Move X
                                if(this.parentNode.nextSibling.classList.contains('wha-letter')) {
                                ...
                                // Move Y
                                    ...
                                    var range = jQuery(this).parent('div.wha-letter').parent('div.row').next('div.row').find('[data-x="'+x+'"]').find('input');
                                    range.focus();
            ...
            jQuery('.wha-char').on('keypress',function(e) {
                ...
                if(window.getSelection && window.getSelection().toString()!='') {
                    ...
                    if( jQuery(this).parent('div.wha-letter').next('div.wha-letter').length > 0) {
                        ...
                        jQuery(this).val(e.char).parent('div.wha-letter').parent('div.row').next('div.row').find('[data-x="'+x+'"]').find('input').focus().select();
                    }
                }
                else {
                    // Move X
                    ...
                    // Move Y
                        ...
                        jQuery(this).parent('div.wha-letter').parent('div.row').next('div.row').find('[data-x="'+x+'"]').find('input').focus().select();
                    }
                }
            });
        }
