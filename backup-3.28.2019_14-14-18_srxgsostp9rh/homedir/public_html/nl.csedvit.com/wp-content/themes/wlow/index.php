 ...
 */
 get_header(); ?>
	...
	<main id="main" class="col-md-9" role="main">
		...
		<?php if ( is_search() ) { ?>
			<h1 class="bigger margin-top"><?php esc_html_e('Result for:', 'wlow'); ?> <strong><i><?php echo $s ?></i></strong></h1>
		<?php } else  if ( is_category() || is_tag() ) { ?>
			<h1 class="bigger margin-top"><?php echo single_cat_title() ?></h1>
		<?php } else if ( is_home() ){ ?>
			<h1 class="bigger"><?php single_post_title(); ?></h1>
		<?php } else if ( is_date() ){ ?>
			<h1 class="bigger margin-top"><?php single_month_title(' '); ?> </h1>
		<?php } else if ( is_archive() ){ ?>
			<h1 class="bigger margin-top"><?php post_type_archive_title(); ?> </h1>
		<?php } ?>
