...
/* Retrive fields */
$wlow_home_latest_news_title = get_theme_mod('wlow__home__latest-news__title', esc_html__('News','wlow'));
$wlow_home_latest_news_subtitle = get_theme_mod('wlow__home__latest-news__subtitle', esc_html__('Our Latest News','wlow'));
